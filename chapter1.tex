...
The presence of a resonance enhances the cross section at its specific center-of-mass energy. The specific increase is highly dependent on the situation since, as a two-step process, it depends on the probability of both forming the compound nucleus and decaying via a specific pathway. To understand this mathematically, consider an isolated, narrow resonance at energy $E_{R}$; the reaction cross section under the influence of such a resonance is described by the Breit-Wigner formula:
...
\begin{equation}
\langle \sigma v \rangle_{BW} = \left( \frac{8}{\pi \mu} \right) ^{1/2} \left( \frac{1}{kT} \right) ^{3/2} \int_{0}^{\infty} \sigma_{BW} (E) E \exp \left(-\dfrac{E}{kT} \right) dE.
...
\begin{equation}
\langle \sigma v \rangle_{BW} = \left( \frac{8}{\pi \mu} \right) ^{1/2} \left( \frac{1}{kT} \right) ^{3/2} E_{R} \exp \left(-\dfrac{E_{R}}{kT} \right) \int_{0}^{\infty} \sigma_{BW} (E) dE.
\end{equation}
...
\begin{equation}
% \int_{0}^{\infty} \sigma_{BW} (E) dE = \pi \lambdabar_{R}^{2} \left(  \frac{2J_R+1}{(2J_1+1)(2J_2+1) \right) (1 + \delta_{12}) \Gamma_{\text{in}} \Gamma_{\text{out}} \int_{0}^{\infty} \dfrac{1}{(E-E_{R})^{2} + (\Gamma_{T}/2)^{2}} dE,
\end{equation}

\noindent which is solved analytically as

\begin{equation}
% \int_{0}^{\infty} \sigma_{BW} (E) dE = \pi \lambdabar_{R}^{2} \left(  \frac{2J_R+1}{(2J_1+1)(2J_2+1) \right)  (1 + \delta_{12}) \frac{\Gamma_{\text{in}} \Gamma_{\text{out}} }{\Gamma_{T}}
\end{equation}
...
\begin{itemize}
\item Breit-Wigner
\item Resonant RR derivation using BW
\item width's and partial width's
\item $\omega \gamma$
...
\begin{itemize}
\item Occurs through quantum tunneling
\item Since s-factor varies smoothly with energy, reaction rate is highly dependent on coulomb penetrability and MB velocity disribution. 
\end{itemize}
